...
- **Nguyên lý:**
  ...
  - Cập nhật trong [globals.css](file:///c:/WORKSPACE/TaskManagementWeb/my-task-app/src/app/globals.css):
    ```css
    .markdown-content,
    .markdown-content p,
    .markdown-content li,
...
- **Kiểm thử Auto-resize khi chuyển tab:** Nhấp sang tab Soạn thảo của Mô tả và Chi tiết, xác minh textarea lập tức mở rộng bao phủ toàn bộ text mà không cần gõ chữ.
